...
export const DEALS: readonly Deal[] = [
  {
    ...
    stageAgeLabel: 'ha 1 dia',
    nextAction: 'Ligar para apresentar catalogo',
  ...
  },
  {
    ...
    stageAgeLabel: 'ha 3 horas',
    nextAction: 'Enviar catalogo de produtos',
  ...
  },
  {
    ...
    stageAgeLabel: 'ha 2 dias',
    nextAction: 'Aguardar retorno sobre orcamento',
  ...
  },
  {
    ...
    company: 'Bella Estetica',
    amountInCents: 210_000,
    ownerName: 'Camila Reis',
    priority: 'baixa',
    enteredStageAt: daysAgo(6),
    stageAgeLabel: 'ha 6 dias',
  ...
  },
  {
    ...
    enteredStageAt: daysAgo(1),
    stageAgeLabel: 'ha 1 dia',
    nextAction: 'Confirmar aprovação do orçamento',
  ...
  },
  {
    ...
    stageId: 'st-proposta',
    contactId: 'ct-joao',
    contactName: 'Joao Pedro Silva',
    company: 'JP Distribuidora',
    amountInCents: 890_000,
    ownerName: 'Camila Reis',
    priority: 'urgente',
    enteredStageAt: daysAgo(9),
    stageAgeLabel: 'ha 9 dias',
    nextAction: 'Reenviar proposta e cobrar retorno',
  ...
  },
  {
    ...
    enteredStageAt: daysAgo(2),
    stageAgeLabel: 'ha 2 dias',
    nextAction: 'Negociar prazo de pagamento',
  ...
  },
  {
    ...
    stageAgeLabel: 'ha 4 dias',
    nextAction: 'Enviar contrato assinado ao financeiro',
