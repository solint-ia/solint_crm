...
export const AI_AGENTS: readonly AiAgent[] = [
  {
    ...
    transferRules: [
      { id: 'tr-1', type: 'palavra_chave', condition: 'falar com humano, atendente, gerente', enabled: true },
      { id: 'tr-2', type: 'intencao', condition: 'Cliente relata problema técnico urgente', enabled: true },
      { id: 'tr-3', type: 'horario', condition: 'Fora do horário comercial (após 18h)', enabled: false },
    ],
    flow: [
      { id: 'fb-c1', type: 'inicio', title: 'Nova conversa no WhatsApp', branches: [{ label: 'Seguir', targetId: 'fb-c2' }] },
      {
        id: 'fb-c2', type: 'mensagem', title: 'Saudação e apresentação',
        detail: 'Oi! Sou o assistente da Solint. Posso te ajudar com planos e demonstração.',
        branches: [{ label: 'Seguir', targetId: 'fb-c3' }],
      },
      {
        id: 'fb-c3', type: 'pergunta', title: 'Qual o principal canal que você usa hoje?',
        detail: 'Guarda a resposta no atributo canal_atual.',
        branches: [{ label: 'Respondeu', targetId: 'fb-c4' }],
      },
      {
        id: 'fb-c4', type: 'condicao', title: 'É lead qualificado?',
      ...
      {
        id: 'fb-c5', type: 'transferir', title: 'Passar para consultor comercial',
        detail: 'Fila Comercial, prioridade alta.', branches: [],
      },
      {
        id: 'fb-c6', type: 'consultar_base', title: 'Responder com a base de planos',
    ...
    logs: [
      ...
      { id: 'lg-2', contactName: 'Lucas Andrade', date: 'Ontem, 17:20', result: 'transferido_humano' },
  ...
  },
  {
    ...
    transferRules: [
      { id: 'tr-4', type: 'palavra_chave', condition: 'reembolso, cancelar, reclamação', enabled: true },
      { id: 'tr-5', type: 'solicitacao_explicita', condition: 'Cliente pede para falar com atendente', enabled: true },
    ],
    flow: [
      { id: 'fb-s1', type: 'inicio', title: 'Mensagem recebida no suporte', branches: [{ label: 'Seguir', targetId: 'fb-s2' }] },
      {
        id: 'fb-s2', type: 'consultar_base', title: 'Procurar na base de conhecimento',
        detail: 'Busca semântica nos artigos publicados.',
        branches: [{ label: 'Seguir', targetId: 'fb-s3' }],
      },
      {
        id: 'fb-s3', type: 'condicao', title: 'Encontrou resposta com confiança alta?',
        branches: [
      ...
      {
        id: 'fb-s4', type: 'mensagem', title: 'Responder e oferecer o artigo',
        branches: [{ label: 'Seguir', targetId: 'fb-s5' }],
      },
      {
        id: 'fb-s5', type: 'pergunta', title: 'Isso resolveu seu problema?',
        branches: [
  ...
  },
  {
    ...
    transferRules: [
      { id: 'tr-6', type: 'palavra_chave', condition: 'desconto, negociar, não vou pagar', enabled: true },
    ],
    flow: [
      { id: 'fb-b1', type: 'inicio', title: 'Fatura vence em 3 dias', branches: [{ label: 'Seguir', targetId: 'fb-b2' }] },
      {
        id: 'fb-b2', type: 'mensagem', title: 'Enviar lembrete com o boleto',
        branches: [{ label: 'Seguir', targetId: 'fb-b3' }],
      },
      {
        id: 'fb-b3', type: 'condicao', title: 'Cliente pediu desconto ou negociação?',
        branches: [
