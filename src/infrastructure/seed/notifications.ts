...
export const NOTIFICATIONS: readonly AppNotification[] = [
  {
    ...
    kind: 'atribuicao',
    text: 'Nova conversa atribuída a você: Mariana Costa',
    timeLabel: 'Há 8 min',
    read: false,
    href: '/conversas',
  },
  {
    ...
    accountId: ACCOUNT_ID,
    kind: 'sla',
    text: 'SLA prestes a estourar: João Pedro Silva (faltam 18 min)',
    timeLabel: 'Há 22 min',
    read: false,
    href: '/conversas',
  },
  ...
  },
  {
    ...
    accountId: ACCOUNT_ID,
    kind: 'mencao',
    text: 'Você foi mencionado por Camila em uma nota interna',
    timeLabel: 'Ontem',
    read: true,
    href: '/conversas',
  },
