...
export const SETTINGS: WorkspaceSettings = {
  ...
  connections: [
    ...
    },
    {
      ...
      channel: 'webchat',
      identifier: 'solint.com.br',
      status: 'desconectado',
      provider: 'Widget embarcado',
  ...
  teams: [
    {
      ...
      name: 'Comercial',
      memberCount: 4,
      inboxes: ['WhatsApp · Comercial', 'Instagram Direct'],
    ...
    },
    {
      ...
      name: 'Suporte N1',
      memberCount: 6,
      inboxes: ['WhatsApp · Suporte', 'Webchat do site'],
